...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('user', JSON.stringify({ id: res.data.userId, name: res.data.name, email }));
      navigate('/dashboard');
    } catch (err) {
    ...
    <div className="min-h-screen gradient-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">Practice with AI-powered video interviews</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button type="submit" disabled={loading}
              className="w-full py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 disabled:cursor-not-allowed text-white font-medium rounded-xl transition shadow-lg shadow-blue-500/25">
              {loading ? (
